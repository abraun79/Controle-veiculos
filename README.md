...
Após a instalação, o sistema estará disponível em `http://localhost/`. Você pode acessar a interface web para gerenciar os veículos, motoristas e registros de entrada/saída.
